    ...
    <>
      ...
      <div className="Home_Segment" ref={Home_SegmentRef}>
        <div className="TextContainer">
          ...
          <div className="Linkedin&GitHub_IconContainer">
            <a
              href="https://github.com/Deen-q"
              target="_blank"
              rel="noopener noreferrer"
            >
              <img src={githubCat} className="githubCat" alt="GitHub Icon" />
            </a>
      ...
      <div className="About_Segment" ref={About_SegmentRef}>
        <div className="TextContainer">
          <h1>About me</h1>
          <h3>
            I have a background in Molecular Biology and Microbiology, which I
            will always love. But I needed something more hands on that would
            offer me a means to actually BUILD things. Enter programming.
          </h3>
          ...
          <h3>
            ...
            , I learned a lot - be it unforgiving logical problems or
            championing a healthy, agile team environment; it required
          ...
          <h3>
            Looking forward to working with genuine people to build great
            things!
          </h3>
          <h3>
      ...
      <div className="Contact_Segment" ref={Contact_SegmentRef}>
        <div className="TextContainer">
          ...
          <div className="LinkedinIconContainer">
            <a
              href="https://www.linkedin.com/in/deen-qureshi/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <img
